...
namespace ForsaWebAPI.Perrsistance.Data
{
    ...
    public partial class ForsaEntities : DbContext
    {
        ...
        [DbFunction("ForsaEntities", "fn_Split")]
        public virtual IQueryable<fn_Split_Result> fn_Split(string @string, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_Split_Result>("[ForsaEntities].[fn_Split](@string, @delimiter)", stringParameter, delimiterParameter);
        }
    
        public virtual int dbo_tblRateOfInterestOfBank_5c35e743_edc9_492c_a48e_f40f641d4db3_QueueActivationSender()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("dbo_tblRateOfInterestOfBank_5c35e743_edc9_492c_a48e_f40f641d4db3_QueueActivationSender");
        }
    
        public virtual ObjectResult<SP_GetBankDetails_Result> SP_GetBankDetails(string userTypeId)
        {
            var userTypeIdParameter = userTypeId != null ?
                new ObjectParameter("UserTypeId", userTypeId) :
                new ObjectParameter("UserTypeId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GetBankDetails_Result>("SP_GetBankDetails", userTypeIdParameter);
        }
